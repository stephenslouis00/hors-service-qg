...
export function ReleaseProgressLine({
  ...
  return (
    <Link
      ...
      className={`block rounded-md border border-zinc-200 px-3 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-900/60 ${className}`}
    >
