...
export function ReleaseProgressLine({ releaseId, title }: { releaseId: string; title: string }) {
  ...
  return (
    <Link
      ...
      className="mb-4 flex items-center gap-2 rounded-md border border-zinc-200 px-3 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-900/60"
    >
